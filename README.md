...
kas-media-native
==========
Kurento native media component implementation for Android

The kas-media-native project provides the native implementation
of media components for android devices. In addition it contains
a JNI (Java Native Interface) interface for its use in Android.
...
[GitHub Repository]: https://github.com/kurento/kas-media-native
